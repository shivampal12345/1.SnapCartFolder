...
function ViewGrocery() {
  ...
  return (
    <div className='pt-4 w-[95%] md:w-[85%] mx-auto pb-20'>
        ...
        className='flex text-center bg-white border border-gray-200 rounded-full px-5 py-3 shadow-sm mb-10
        hover:shadow-lg transition-all max-w-lg mx-auto w-full'
        >
                    ...
                    <div className='flex-1 flex flex-col justify-between w-full'>
                        ...
                        <div className='mt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2'>
                            <p className='text-green-700 font-bold text-lg'>
                                ₹{g.price}/<span className='text-gray-500 text-sm'>{g.unit}</span>
                            </p>
            ...
            {editing && (
                ...
                >
                    ...
                    >
                        ...
                        <div className='relative aspect-square w-full rounded-lg overflow-hidden mb-4 border
                        ...
                        <div className='space-y-4'>
                            ...
                            <select className='w-full border border-gray-300 rounded-lg p-2.5 focus:ring-2
                       ...
                       <div className='flex justify-end gap-3 mt-6'>
                        ...
                        <button className='px-4 py-2 rounded-lg  bg-red-600 text-white flex items-center gap-2
                         hover:bg-red-700 transition'onClick={handleDelete} disabled={deleteLoading}>
                            {loading?<Loader size={14}/>:"Delete Grocery"}
                        </button>
                       </div>
