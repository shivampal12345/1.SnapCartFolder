...
function AddGrocery() {
  ...
  return (
    ...
    to-white py-16 px-4 relative'>
        <Link href={"/"} className='absolute top-6 left-6 flex items-center gap-2 text-green-700 font-semibold bg-white
          ...
          <form className='flex flex-col gap-6 w-full' onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className='block text-gray-700 font-medium mb-1'>Grocery Name 
                ...
                <input type="text" id='name' placeholder='eg: sweets,milk...' className='w-full border border-gray-300 rounded-xl
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
              ...
              <div>
                ...
                <select name="units" className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2
                focus:ring-green-400 transition-all bg-white'
             ...
             <div>
              <label htmlFor="name" className='block text-gray-700 font-medium mb-1'>Price 
                <span className='text-red-500'>*</span></label>
                <input type="text" id='name' placeholder='eg: 120' className='w-full border border-gray-300 rounded-xl
                px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all'
             ...
             <div className='flex flex-col sm:flex-row items-center gap-5'>
              ...
              px-6 py-3 hover:bg-green-200 transition-all w-full sm:w-auto'><Upload className='w-5 h-5'/>Upload Image</label>
            ...
            whileTap={{scale:0.9}}
            disabled={loading}
            className='mt-4 w-full bg-linear-to-r from-green-500 to-green-700 text-white font-semibold py-3 rounded-xl
            shadow-lg hover:shadow-xl disabled:opacity-60 transition-all flex items-center justify-center gap-2'
            >
