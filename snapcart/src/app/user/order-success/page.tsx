...
function OrderSuccess() {
  return (
    ...
    bg-linear-to-b from-green-50 to-white'>
        ...
        >
            Thank You for shopping with us! Yor order has been placed and is being processed.
            You can track its progress in your <span className='font-semibold text-green-700 cursor-pointer'>My Orders</span> section.
        </motion.p>
        <motion.div
