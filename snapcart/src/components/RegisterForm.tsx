...
function RegisterForm({previousStep}:propType) {
  ...
  return (
    ...
    py-10 bg-white relative'>
        <div className='absolute top-6 left-6 flex items-center gap-2 text-green-700 hover:text-green-800
        ...
        <div className='relative'>
         ...
         <div className='relative'>
            ...
            <input type="text" placeholder='Your Mail' className='w-full border border-gray-300 rounded-xl
            py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none' 
        ...
        <div className='w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-100
        py-3 rounded-xl text-gray-700 font-medium transition-all duration-200 cursor-pointer' onClick={()=>signIn("google",
            {callbackUrl:"/"}
        )}>
        ...
        onClick={()=>router.push("/login")}>Already Have an Account? <LogIn className='
        w-4 h-4'/><span className='text-green-600'>Sign in</span></p>
    </div>
  )
}
