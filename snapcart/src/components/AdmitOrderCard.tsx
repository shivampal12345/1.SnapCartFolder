...
function AdmitOrderCard({order}:{order:IOrder}) {
  ...
  return (
    ...
    className='bg-white shadow-md hover:shadow-lg border border-gray-100 rounded-xl p-6 transition-all'
    >
        <div className='flex flex-col md:flex-row md:items-start md:justify-between gap-4'>
            <div className='space-y-1'>
                ...
                <p className='mt-3 flex items-center gap-2 text-sm text-gray-700'>
                    ...
                    {order.assignedDeliveryBoy && <div className="mt-4 bg-blue-50 border border-blue-200 rounded-xl
            ...
            <div className='flex flex-col items-start md:items-end gap-2'>
                ...
                {status !=="delivered" &&  <select className='border border-gray-300 rounded-lg px-3 py-1 text-sm hover:border-green-400
                transition focus:ring-2 focus:ring-green-500 outline-none' value={status}
         ...
         <div className='border-t  border-gray-200 mt-3 pt-3'>
                ...
                >
                    <div className='mt-3 space-y-3'>
                       {order.items.map((item,index)=>(
                        <div key={index} className='flex justify-between items-center bg-gray-50 rounded-xl px-3 py-2
             ...
             <div className='border-t pt-3 mt-3 flex justify-between items-center text-sm font-semibold text-gray-800'>
                            <div className='flex items-center gap-2 text-gray-700 text-sm'>
                                ...
                                <span>Delivery: <span className='text-green-600 font-semibold'>{status}</span></span>
                            </div>
                            <div>
